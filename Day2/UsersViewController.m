...
//  Day2
//
//  Created by Faik Catibusic on 12/5/14.
...
- (void)viewDidLoad {
    ...
    User *user3 = [[User alloc] initWithFirstName:@"User" andLastName:@"2"];
    User *user4 = [[User alloc] initWithFirstName:@"User" andLastName:@"2"];
    User *user5 = [[User alloc] initWithFirstName:@"User" andLastName:@"2"];
